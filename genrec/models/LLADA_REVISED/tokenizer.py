...
"""
Tokenizer for LLADA Revised model - extends RPG tokenizer with MASK token
...
class LLADARevisedTokenizer(RPGTokenizer):
    """
    LLADA Revised Tokenizer with MASK token support
    ...
    Vocabulary structure:
        ...
        8193: [EOS]
        8194: [MASK]  ← New for LLADA Revised
    """
